---
name: new-report
description: Research and publish a new founder report for a stage or event on the Sports Analyst AI Agent site. Use when the user says new report, write a report, research the next round, publish picks for a stage, or types /new-report (for example /new-report World Cup quarterfinals). The stage or event to cover is the argument.
user-invocable: true
allowed-tools:
  - Read
  - Write
...
Research and publish a new founder report for the stage or event named in the request (the argument, for example "World Cup quarterfinals").
