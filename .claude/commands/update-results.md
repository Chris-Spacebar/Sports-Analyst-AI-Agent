...
Both must pass. Then confirm the track record grades correctly: load http://localhost:3000 and http://localhost:3000/research and check that the settled and correct counts match what you graded in step 3.
